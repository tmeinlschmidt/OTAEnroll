...
class ApplicationControllerTest < ActionController::TestCase
  ...
  test "should get profile" do
    ...
    FakeWeb.register_uri(:get, 'http://192.168.1.129/callback?imei=01+335200+242816+7&product=iPhone5%2C2&sign=952cb7489cd67c477faaf22ac4019411b30ba9c4&udid=ea750fdbc619ca406d066d7ed158d54483fc382f&uid=znouza&version=10A525', body: 'OK', status: [200, 'OK'])
    ...
    assert_equal '/callback?imei=01+335200+242816+7&product=iPhone5%2C2&sign=952cb7489cd67c477faaf22ac4019411b30ba9c4&udid=ea750fdbc619ca406d066d7ed158d54483fc382f&uid=znouza&version=10A525', last_request.path
    assert_equal 'application/x-apple-aspen-config', response.content_type
  end
